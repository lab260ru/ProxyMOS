...
try:
    from WhiSQA.models.whisper_wrapper import WhisperWrapper_full,WhisperWrapper_encoder,pad_or_trim, log_mel_spectrogram
    from WhiSQA.models.transformer_wrapper import TransformerWrapper
    from WhiSQA.models.transformer_config import CenterCrop,Config,Input
except:
    from WhiSQA.models.whisper_wrapper import WhisperWrapper_full,WhisperWrapper_encoder, pad_or_trim, log_mel_spectrogram
    from WhiSQA.models.transformer_wrapper import TransformerWrapper
    from WhiSQA.models.transformer_config import CenterCrop,Config,Input    
